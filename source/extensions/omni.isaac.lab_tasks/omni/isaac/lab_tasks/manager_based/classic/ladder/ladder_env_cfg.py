...
class RewardsCfg:
    ...
    heading_forward = RewTerm(func=mdp.heading_forward, weight=0.2)
...
class TerminationsCfg:
    ...
    # terminate if robot not upright enough
    torso_upright = DoneTerm(func=mdp.bad_orientation, params={"limit_angle": 30.0/180.0*np.pi})
