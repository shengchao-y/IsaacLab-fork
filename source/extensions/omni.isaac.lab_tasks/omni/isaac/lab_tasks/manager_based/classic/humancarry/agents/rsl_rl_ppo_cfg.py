...
class HumancarryPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    rewards_expect = {
        ...
        "rew_hand2box": GoalReward(name="rew_hand2box", 
                                   max_value=0.2, gage_init_std=0.6, gage_change_rate=1.0),
        "rew_handonbox": GoalReward(name="rew_handonbox", 
                                    max_value=0.8, gage_init_std=0.5, gage_change_rate=1.0),
        ...
        "rew_boxontarget": GoalReward(name="rew_boxontarget", 
                                      max_value=0.8, gage_init_std=0.3, gage_change_rate=1.0),
    }
    # gage_init_std = 0.0
