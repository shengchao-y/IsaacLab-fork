...
from isaaclab_assets import ANT_CFG  # isort: skip
...
class RewardsCfg:
    ...
    rew_orientation = RewTerm(
        func=mdp.keep_orientation, weight=1.0, params={"target_quat": (1.0, 0.0, 0.0, 0.0)}
    )
...
class TerminationsCfg:
    ...
    torso_orientation = DoneTerm(
        func=mdp.bad_orientation_quat,
        params={"limit_angle_diff": math.pi / 6, "target_quat": (1.0, 0.0, 0.0, 0.0)},
    )
