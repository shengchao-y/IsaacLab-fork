...
parser.add_argument("--run_name_baseline", type=str, default=None, help="Run name suffix to the log directory.")
parser.add_argument("--checkpoint_baseline", type=str, default=None, help="Checkpoint file to resume from.")
...
# python source/standalone/workflows/rsl_rl/play2.py --task Isaac-Humanoid-v0 --num_envs 2 --run_name=gage75 --checkpoint humanspeed_gage75_s4_model_5999.pt --run_name_baseline=gage0 --checkpoint_baseline humanspeed_gage0_s1_model_5999.pt --video
